...
insert  into `category`(`cat_id`,`parent_id`,`name`,`status`,`sort_order`,`create_time`,`update_time`,`level`,`is_leaf`) values (1,NULL,'全部',1,1,NULL,NULL,0,'n'),(2,1,'电脑',1,1,NULL,NULL,1,'n'),(3,1,'手机',1,2,NULL,NULL,1,'n'),(4,1,'服装',2,3,NULL,NULL,1,'n');
...
insert  into `goods`(`goods_id`,`product_id`,`goods_sn`,`spec`,`stock`,`sales`,`price`,`display_price`,`create_time`,`update_time`,`version`,`product_pic_id`,`status`) values (1,1,1001,'{\"网络\":\"电信3G\",\"颜色\":\"白\"}',100,1,1399,1599,NULL,NULL,0,1,NULL),(2,2,1002,NULL,100,1,1599,1999,NULL,NULL,0,2,NULL),(3,3,1003,NULL,500,0,5000,6000,NULL,NULL,0,3,NULL),(4,3,1004,NULL,600,0,5500,6500,NULL,NULL,0,4,NULL),(5,3,1005,NULL,300,0,5100,6100,NULL,NULL,0,5,NULL),(6,3,1006,NULL,200,0,5200,6200,NULL,NULL,0,6,NULL),(7,1,1007,'{\"网络\":\"电信3G\",\"颜色\":\"黑\"}',99,90,1299,1399,NULL,NULL,0,NULL,NULL),(8,1,1008,'{\"网络\":\"移动3G\",\"颜色\":\"白\"}',98,80,1199,1299,NULL,NULL,0,NULL,NULL);
...
/*Data for the table `order_history_status` */

/*Data for the table `packing_list` */

insert  into `packing_list`(`id`,`product_id`,`goods_name`,`num`,`status`,`create_time`,`update_time`) values (1,1,'手机',1,1,NULL,NULL),(2,1,'充电器',1,1,NULL,NULL),(3,1,'耳机',1,1,NULL,NULL),(4,1,'说明书',1,1,NULL,NULL);
...
insert  into `product`(`product_id`,`kind_id`,`shop_id`,`shop_name`,`product_name`,`product_title`,`brand_id`,`brand_name`,`view_num`,`status`,`pay_type`,`delevery_amount`,`min_price`,`max_price`,`pic_url`,`comment_times`,`score`,`create_time`,`update_time`,`sales`) values (1,1,1,'自营','小米2S','小米2S 正品行货 特价销售',1,'小米',1,1,1,5,1999,2099,'common/images/product/1.jpg',3258,48,NULL,NULL,8000),(2,1,1,'自营','小米3',NULL,1,'小米',1,1,1,5,2499,2599,'common/images/product/2.jpg',12,47,NULL,NULL,889),(3,1,1,'自营','iPhone5S',NULL,2,'APPLE',1,1,1,5,4999,5499,'common/images/product/4.jpg',NULL,50,NULL,NULL,200);
...
insert  into `product_cat`(`id`,`product_id`,`cat_id`,`create_time`,`update_time`,`sort_order`,`status`) values (1,1,3,'2014-06-17 21:15:52','2014-06-17 21:15:52',1,1),(2,2,3,'2014-06-17 21:15:52','2014-06-17 21:15:52',2,1),(3,3,3,'2014-06-17 21:15:52','2014-06-17 21:15:52',3,1);
...
insert  into `product_pic`(`product_pic_id`,`product_id`,`url`,`image_name`,`post_fix`,`brief_name`,`use_type`,`status`) values (1,1,'common/images/product/1.jpg',NULL,NULL,NULL,2,1),(2,1,'common/images/product/2.jpg',NULL,NULL,NULL,2,1),(3,1,'common/images/product/3.jpg',NULL,NULL,NULL,2,1),(4,1,'common/images/product/4.jpg',NULL,NULL,NULL,2,1),(5,1,'common/images/product/5.webp',NULL,NULL,NULL,1,1),(6,1,'common/images/product/6.jpg',NULL,NULL,NULL,3,1);
...
insert  into `user`(`user_id`,`rank_id`,`user_name`,`user_real_name`,`phone_num`,`mail`,`sex`,`status`,`integral`,`create_time`,`update_time`) values (1,1,'hexizheng','贺夕政','13851402609','hexizheng@163.com','m',1,1000,NULL,NULL);
